...
class MailboxWSClient:
    ...
    def _format_incoming(
        ...
        return (
            ...
            f"\n"
            f"↩️ How to reply:\n"
            f"You may use any tools you need to research or prepare your response.\n"
            f"When ready, wrap your final reply EXACTLY like this — nothing outside the markers:\n"
            f"\n"
            f"%%\n"
            f"<your reply text here>\n"
            f"%%\n"
            f"\n"
            f"The daemon extracts only the text between %% markers and sends it to {from_agent}.\n"
            f"Everything outside the markers (tool calls, reasoning, scratch work) is ignored.\n"
